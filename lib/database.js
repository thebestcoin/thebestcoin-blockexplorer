var mongoose = require('mongoose')
  ...
  , bestcoin = require('./markets/bestcoin');
...
function get_market_data(market, cb) {
  switch(market) {
    ...
    case 'empoex':
      ...
      break;
    case 'bestcoin':
      bestcoin.get_data(settings.markets.coin, settings.markets.exchange, settings.markets.bestcoin_http_url, settings.markets.bestcoin_http_user, settings.markets.bestcoin_http_password, function(err, obj){
        return cb(err, obj);
      });
      break;
    default:
